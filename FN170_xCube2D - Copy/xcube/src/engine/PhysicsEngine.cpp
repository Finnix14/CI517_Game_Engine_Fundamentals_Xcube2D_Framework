...
//sets the center point of the physics object
void PhysicsObject::setCenter(const Point2& p)
{
	center = p;
}
//gets the center point of the physics object
Point2 PhysicsObject::getCenter() const
{
	return center;
}
